...
| ----- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| PS-01 | *Implementation of Buckingham's Pi Theorem Using Python*  | Automates the generation of π-groups from physical variables using Python; validated through fluid dynamics problems.          |
