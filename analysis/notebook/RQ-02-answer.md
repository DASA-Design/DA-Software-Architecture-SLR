...
| ----- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| PS-01 | *Implementation of Buckingham's Pi Theorem Using Python*  | Engineers develop reusable Python tools for automatically deriving π-groups; applied to fluid mechanics as computational examples.         |
